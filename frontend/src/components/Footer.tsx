...
const Footer: React.FC = () => {
  return (
    <footer className="py-6 sm:py-8 bg-gray-800 text-gray-300 text-center px-4">
      <p className="text-sm sm:text-base">
        &copy; {new Date().getFullYear()} <span className="font-semibold">Awwab Wadekar</span>. All rights reserved.
      </p>
